...
<div class="container ">
    ...
    <div class="row shadow-lg  mb-5  text-dark bg-opacity-10">
   
        <div class="col p-5">
    <img src="images/R.png" class="mx-auto d-block animate__animated animate__backInDown" width="500px" height="500px">
    <a href="pages-electeur/index.php" type="button" class="col-4 mx-auto d-block btn btn-success  animate__animated animate__bounceIn p-3"><h4>Commencer votre Vote</h4></a>
    </div>
